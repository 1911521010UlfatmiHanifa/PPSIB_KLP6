<?php
    ...
    if(!$hasil = $conn->query("SELECT * FROM peminjaman join user on user.id_user=peminjaman.id_user join instansi on
                            user.id_instansi=instansi.id_instansi where status_harga is null and status_peminjaman='Disetujui Divisi Rumah Tangga'")){
...
<head>
  ...
  <title>Data Pengajuan Peminjaman Inventaris Yang Akan Disetujui</title>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td width="105px" class="text-center">
                        <a role="button" href="peminjaman_konfirmasi_pm.php?id_peminjaman=<?php echo $row['id_peminjaman'];?>" class="btn btn-outline-warning btn-sm bi bi-eye">
                        </a> &nbsp;
                    </td>
                  </tr>
                <?php } ?>
