<?php
    ...
    if(!$hasil = $conn->query("SELECT * FROM peminjaman join user on user.id_user=peminjaman.id_user join instansi on
                            user.id_instansi=instansi.id_instansi where status_peminjaman='Ditolak Divisi Rumah Tangga'
                            or status_harga='Ditolak Peminjam' or status_harga='Ditolak Divisi Pemasaran'")){
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Data Peminjaman Inventaris</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
