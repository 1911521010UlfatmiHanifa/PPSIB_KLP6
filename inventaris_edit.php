    ...
    if(isset($_POST['simpan'])){
		...
		if (in_array($ekstensiGambar, $ekstensiGambarValid) === true) {
			if ($ukuranFile < 1044070) {
                ...
                $stmt->bind_param("siissi", $nama_inventaris, $harga_mahasiswa, $harga_nonmahasiswa, $namaFile, $keterangan, $id_inventaris);
                $stmt->execute();
...
<head>
    ...
    <title>Form Edit Data Inventaris</title>
...
<body>
    ...
    <main id="main" class="main">
        ...
        <nav>
            ...
            <li class="breadcrumb-item active">Form Edit Data Inventaris</li>
            </ol>
        </nav>
        </div><!-- End Page Title -->
            ...
            <div class="card">
                ...
                <form class="row g-3 needs-validation" method="post" novalidate enctype="multipart/form-data">
                    <div class="col-6">
                        ...
                        <input type="text" name="nama_inventaris" class="form-control" id="nama_inventaris" value="<?php echo $nama_inventaris?>" pattern="^[A-Za-z]+([\A-Za-z]+)*" autofocus required>
                        <div class="invalid-feedback">Masukkan Nama Inventaris!</div>
                    </div>

                    <div class="col-6">
                        <label for="yourketerangan" class="form-label">Keterangan</label>
                        <input type="text" name="keterangan" class="form-control" id="keterangan" value="<?php echo $keterangan?>" required>
                    ...
                    <div class="col-6">
                        ...
                        <div class="input-group has-validation">
                            <input type="number" min="0" name="harga_mahasiswa" class="form-control" id="harga_mahasiswa" value="<?php echo $harga_mahasiswa?>" required>
                    ...
                    <div class="col-6">
                        ...
                        <div class="input-group has-validation">
                            <input type="number" min="0" name="harga_nonmahasiswa" class="form-control" id="harga_nonmahasiswa" value="<?php echo $harga_nonmahasiswa?>" required>
